...
class TrustListManager:
    ...
    def save_metadata(self):
        ...
        metadata = {
            "ctl_number": self.ctl_number,
            "base_ctl_number": self.base_ctl_number,
            "last_full_ctl_time": self.last_full_ctl_time.isoformat() if self.last_full_ctl_time else None,
            "trust_anchors_count": len(self.trust_anchors),
    ...
    def get_statistics(self):
        ...
        stats = {
            ...
            "last_full_ctl": self.last_full_ctl_time.isoformat() if self.last_full_ctl_time else None,
